...
show_ads: true
description: Balloons, aircraft parts and military debris can look strange enough to seed a crash legend when context is missing.
hero_summary: Balloons, aircraft parts and military debris can look strange enough to seed a crash legend when context is missing.
layout: default
permalink: /wreckage/
sidebar_expanded_urls:
- /ufo-crashes/
- /crashes-vs-sightings/
nav_short_title: Wreckage
title: When Ordinary Debris Looks Alien
title_full: When Ordinary Debris Looks Alien
display_title_short: Wreckage
display_title: Wreckage
heading_title: When Ordinary Debris Looks Alien
page_heading_title: When Ordinary Debris Looks Alien
source_count: 55
infographic_count: 3
planned_sections:
...
The public often expects [aircraft]({{ 'aircraft/' | relative_url }}) wreckage to resemble twisted metal from a conventional crash. However, many aerospace and military systems use materials that can appear unusual when found in isolation.

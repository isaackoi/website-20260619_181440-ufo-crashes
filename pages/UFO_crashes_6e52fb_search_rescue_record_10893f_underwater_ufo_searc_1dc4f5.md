...
show_ads: true
description: Underwater searches can make a case more testable, but an empty seabed search still leaves several ordinary possibilities open.
hero_summary: Underwater searches can make a case more testable, but an empty seabed search still leaves several ordinary possibilities open.
layout: default
permalink: /diver-searches/
sidebar_expanded_urls:
- /ufo-crashes/
- /search-trails/
nav_short_title: Diver searches
title: When UFO Searches Go Underwater
title_full: When UFO Searches Go Underwater
display_title_short: Diver searches
display_title: Diver searches
heading_title: When UFO Searches Go Underwater
page_heading_title: When UFO Searches Go Underwater
source_count: 38
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Did Kecksburg Searchers Find Anything?
header:
  og_image: /assets/images/UFO_crashes_6e52fb_search_rescue_record_10893f_underwater_ufo_searc_1dc4f5-Illustration-1-social.jpg
  preview_image: /assets/images/UFO_crashes_6e52fb_search_rescue_record_10893f_underwater_ufo_searc_1dc4f5-Illustration-1.webp
image: /assets/images/UFO_crashes_6e52fb_search_rescue_record_10893f_underwater_ufo_searc_1dc4f5-Illustration-1-social.jpg
---

## Introduction

Some UFO [crash reports]({{ 'crash-reports/' | relative_url }}) become more testable when witnesses claim that an object entered a lake, harbour or ocean rather than disappearing over land. A reported water impact creates a practical question: if something large struck the water, can divers, sonar operators or recovery teams find it? This is where many UFO crash stories move from eyewitness testimony into search-and-rescue operations.
...
When police, coast guards or military authorities receive reports of an object striking water, the initial assumption is usually not that a UFO has crashed. The concern is far more ordinary: a possible [aircraft accident]({{ 'aircraft/' | relative_url }}), missing vessel, falling [space debris]({{ 'space-debris/' | relative_url }}), or a threat to public safety.
...
This distinction helps explain why some researchers view documented dive operations as valuable [evidence]({{ 'evidence/' | relative_url }}) while remaining cautious about the conclusions drawn from them. The existence of a search is a fact. The interpretation of a negative result is much less straightforward.

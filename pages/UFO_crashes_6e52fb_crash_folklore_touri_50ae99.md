...
- UFO_crashes_6e52fb_crash_folklore_touri_50ae99_index
...
show_ads: true
description: Some crash stories become place-based legends that shape identity, tourism, and memorabilia even when evidence is weak.
hero_summary: Some crash stories become place-based legends that shape identity, tourism, and memorabilia even when evidence is weak.
layout: default
permalink: /tourism/
sidebar_expanded_urls:
- /ufo-crashes/
nav_short_title: Tourism
title: How Crash Stories Become Local Legends
title_full: How Crash Stories Become Local Legends
display_title_short: Tourism
display_title: Tourism
heading_title: How Crash Stories Become Local Legends
page_heading_title: How Crash Stories Become Local Legends
source_count: 132
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why UFO Does Not Mean Alien
header:
  og_image: /assets/images/UFO_crashes_6e52fb_crash_folklore_touri_50ae99-overview-social.jpg
  preview_image: /assets/images/UFO_crashes_6e52fb_crash_folklore_touri_50ae99-overview.webp
image: /assets/images/UFO_crashes_6e52fb_crash_folklore_touri_50ae99-overview-social.jpg
---

## Introduction

UFO crash folklore turns an alleged [impact site]({{ 'impact-site/' | relative_url }}) into a place people can visit, photograph, joke about, argue over and buy [souvenirs]({{ 'souvenirs/' | relative_url }}) from. The claims may be weak as evidence for extraterrestrial craft, but they can become strong as local culture: Roswell’s alien shopfronts, Kecksburg’s “space acorn”, Shag Harbour’s waterfront interpretive centre and Aurora’s cemetery legend all show how a crash story can become a civic asset. The key point is not that tourism proves the crash. It is almost the opposite: tourism often survives because the story is unresolved, flexible and easy to perform in public. A visitor does not have to believe every witness account to enjoy a festival, museum, parade, roadside marker or alien-themed gift shop.


<img src="{{ "/assets/images/UFO_crashes_6e52fb_crash_folklore_touri_50ae99-overview.webp" | relative_url }}" alt="Overview image for Tourism" loading="eager" decoding="sync" fetchpriority="high">
Within the wider subject of [UFO crashes]({{ 'ufo-crashes/' | relative_url }}), tourism matters because it changes the life of a claim. A crash report begins as a disputed event; over time, it can become a local brand, an annual ritual, a way to attract visitors, and a shared joke that residents can either embrace, tolerate or contest. Roswell is the best-known example, but smaller cases show the mechanism even more clearly: the weaker or stranger the material [evidence]({{ 'evidence/' | relative_url }}), the more important place, memory and performance become.
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_crash_folklore_touri_50ae99-Illustration-3-dark.svg" | relative_url }}" alt="Tourism illustration 3" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_crash_folklore_touri_50ae99-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_crash_folklore_touri_50ae99-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

...
show_ads: true
description: A fragment can look strange in a lab, but recovery photos, maps, notes and seals decide whether it can be tied to a crash claim.
hero_summary: A fragment can look strange in a lab, but recovery photos, maps, notes and seals decide whether it can be tied to a crash claim.
layout: default
permalink: /site-records/
sidebar_expanded_urls:
- /ufo-crashes/
- /custody/
nav_short_title: Site Records
title: What Would Prove Where Wreckage Came From?
title_full: What Would Prove Where Wreckage Came From?
display_title_short: Site Records
display_title: Site Records
heading_title: What Would Prove Where Wreckage Came From?
page_heading_title: What Would Prove Where Wreckage Came From?
source_count: 63
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Can Tests Rescue the Ubatuba Fragments?
header:
  og_image: /assets/images/UFO_crashes_6e52fb_chain_of_custody_70063d_recovery_site_record_b1e5b9-Illustration-1-social.jpg
  preview_image: /assets/images/UFO_crashes_6e52fb_chain_of_custody_70063d_recovery_site_record_b1e5b9-Illustration-1.webp
image: /assets/images/UFO_crashes_6e52fb_chain_of_custody_70063d_recovery_site_record_b1e5b9-Illustration-1-social.jpg
---

## Introduction

A laboratory can determine what a fragment is made of, but it usually cannot determine where that fragment came from. In UFO crash-[retrieval claims]({{ 'retrieval-claims/' | relative_url }}), that distinction is crucial. An unusual alloy, layered material or oddly damaged fragment may attract attention, yet the central question remains whether the tested object is actually the same object allegedly recovered from a crash site. Recovery-site [records]({{ 'records/' | relative_url }}) are the bridge between a physical sample and the story attached to it.
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_chain_of_custody_70063d_recovery_site_record_b1e5b9-Illustration-3-dark.svg" | relative_url }}" alt="Site Records illustration 3" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_chain_of_custody_70063d_recovery_site_record_b1e5b9-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_chain_of_custody_70063d_recovery_site_record_b1e5b9-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Provenance Often Matters More Than the Material

...
show_ads: true
description: The first reports often decide whether a crash story has a recoverable core or mainly later folklore.
hero_summary: The first reports often decide whether a crash story has a recoverable core or mainly later folklore.
layout: default
permalink: /earliest-records/
sidebar_expanded_urls:
- /ufo-crashes/
- /evaluate-claims/
nav_short_title: Earliest Records
title: What did the first records actually say?
title_full: What did the first records actually say?
display_title_short: Earliest Records
display_title: Earliest Records
heading_title: What did the first records actually say?
page_heading_title: What did the first records actually say?
source_count: 46
infographic_count: 3
planned_sections:
...
image: /assets/images/UFO_crashes_6e52fb_evaluate_crash_claim_69323f_earliest_records_62c8b3-Illustration-1-social.jpg
---

## Introduction

When evaluating a UFO crash claim, the most important [evidence]({{ 'evidence/' | relative_url }}) is often not the most dramatic evidence. It is the earliest evidence. The first police call, rescue log, military message, newspaper report, air-traffic inquiry, or incident form usually reveals what witnesses and officials believed before rumours, books, documentaries, and decades of retelling reshaped the story. In many famous cases, the gap between the first [records]({{ 'records/' | relative_url }}) and later narratives is where credibility is either strengthened or weakened.
...
* Do independent records agree on the [timing]({{ 'timing/' | relative_url }}) and location?
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_evaluate_crash_claim_69323f_earliest_records_62c8b3-Illustration-2-dark.svg" | relative_url }}" alt="Earliest Records illustration 2" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_evaluate_crash_claim_69323f_earliest_records_62c8b3-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_evaluate_crash_claim_69323f_earliest_records_62c8b3-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
[Missing records]({{ 'missing-records/' | relative_url }}) create uncertainty, but uncertainty is not evidence of a cover-up.
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_evaluate_crash_claim_69323f_earliest_records_62c8b3-Illustration-3-dark.svg" | relative_url }}" alt="Earliest Records illustration 3" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_evaluate_crash_claim_69323f_earliest_records_62c8b3-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_evaluate_crash_claim_69323f_earliest_records_62c8b3-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

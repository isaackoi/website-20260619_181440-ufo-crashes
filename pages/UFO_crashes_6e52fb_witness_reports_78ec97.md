...
- UFO_crashes_6e52fb_witness_reports_78ec97_index
...
show_ads: true
description: Witnesses can be sincere and important, but crash claims need a way to separate memory, perception, and later retelling.
hero_summary: Witnesses can be sincere and important, but crash claims need a way to separate memory, perception, and later retelling.
layout: default
permalink: /witnesses/
sidebar_expanded_urls:
- /ufo-crashes/
nav_short_title: Witnesses
title: How Much Can Witnesses Prove?
title_full: How Much Can Witnesses Prove?
display_title_short: Witnesses
display_title: Witnesses
heading_title: How Much Can Witnesses Prove?
page_heading_title: How Much Can Witnesses Prove?
source_count: 103
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Why UFO Does Not Mean Alien
header:
  og_image: /assets/images/UFO_crashes_6e52fb_witness_reports_78ec97-overview-social.jpg
  preview_image: /assets/images/UFO_crashes_6e52fb_witness_reports_78ec97-overview.webp
image: /assets/images/UFO_crashes_6e52fb_witness_reports_78ec97-overview-social.jpg
---

## Introduction

Witness reports are often the emotional centre of alleged UFO crash cases. They can be sincere, detailed and socially costly for the people who give them. Yet they rarely prove a crash by themselves, because crash claims require more than an honest recollection: they require a way to separate immediate observation from memory drift, rumour, misidentification, later retelling and missing [physical evidence]({{ 'evidence/' | relative_url }}). The strongest witness accounts are those recorded close to the event, independently repeated by multiple observers, and tied to emergency logs, search activity, radar, photographs, debris, medical [records]({{ 'records/' | relative_url }}) or recoverable materials. The weakest are late, second-hand or shaped by decades of books, documentaries and local folklore.


<img src="{{ "/assets/images/UFO_crashes_6e52fb_witness_reports_78ec97-overview.webp" | relative_url }}" alt="Overview image for Witnesses" loading="eager" decoding="sync" fetchpriority="high">
...
* debris with a documented [chain of custody]({{ 'custody/' | relative_url }});

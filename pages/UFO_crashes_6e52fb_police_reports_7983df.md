...
- UFO_crashes_6e52fb_police_reports_7983df_index
...
show_ads: true
description: Police involvement can make a case more serious, but official attention does not automatically prove extraordinary origin.
hero_summary: Police involvement can make a case more serious, but official attention does not automatically prove extraordinary origin.
layout: default
permalink: /police-reports/
sidebar_expanded_urls:
- /ufo-crashes/
nav_short_title: Police Reports
title: What Police Reports Can and Cannot Prove
title_full: What Police Reports Can and Cannot Prove
display_title_short: Police Reports
display_title: Police Reports
heading_title: What Police Reports Can and Cannot Prove
page_heading_title: What Police Reports Can and Cannot Prove
source_count: 136
infographic_count: 3
planned_sections:
...
image: /assets/images/UFO_crashes_6e52fb_police_reports_7983df-overview-social.jpg
---

## Introduction

Police reports matter in alleged [UFO crashes]({{ 'ufo-crashes/' | relative_url }}) because they often capture the first official version of an incident: who called, what was feared, where officers went, whether an [aircraft]({{ 'aircraft/' | relative_url }}) was missing, and whether a search or cordon followed. They can make a crash claim more serious than a campfire story, but they cannot by themselves prove an extraordinary origin. A police log normally proves that people reported something alarming and that authorities responded; it does not prove that the reported object was a spacecraft, a weapon, a meteorite, a balloon, or anything else.


<img src="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-overview.webp" | relative_url }}" alt="Overview image for Police Reports" loading="eager" decoding="sync" fetchpriority="high">
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-1-dark.svg" | relative_url }}" alt="Police Reports illustration 1" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-2-dark.svg" | relative_url }}" alt="Police Reports illustration 2" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Limits of authority as evidence
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-3-dark.svg" | relative_url }}" alt="Police Reports illustration 3" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

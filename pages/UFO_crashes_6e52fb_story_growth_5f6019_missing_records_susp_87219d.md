...
show_ads: true
description: Destroyed or misplaced files can keep a crash story alive even when the surviving evidence points elsewhere.
hero_summary: Destroyed or misplaced files can keep a crash story alive even when the surviving evidence points elsewhere.
layout: default
...
title: When Missing Files Become UFO Evidence
title_full: When Missing Files Become UFO Evidence
display_title_short: Missing Files
display_title: Missing Files
heading_title: When Missing Files Become UFO Evidence
page_heading_title: When Missing Files Become UFO Evidence
source_count: 47
infographic_count: 3
planned_sections:
- Ordinary archival gaps
- Roswell and Kecksburg records
- The leap from absence to cover up
...
image: /assets/images/UFO_crashes_6e52fb_story_growth_5f6019_missing_records_susp_87219d-Illustration-1-social.jpg
---

## Introduction

One of the most durable engines behind UFO crash stories is not a witness, photograph or fragment of debris. It is a missing file.
...
The problem is that a missing record rarely tells researchers why it disappeared. Several explanations may fit equally well:
...
* Deliberate destruction to conceal extraordinary information.
...
## Roswell and the Missing Records Question
...
## Kecksburg and the Power of Lost Paperwork
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/b_6-iVz1R0o" title="The pattern behind self-deception | Michael Shermer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=b_6-iVz1R0o" target="_blank" rel="noopener noreferrer">The pattern behind self-deception | Michael Shermer</a></p><p class="youtube-embed-meta">Channel: TED</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=b_6-iVz1R0o" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=b_6-iVz1R0o">Open on YouTube</a></p></div></div></div>

## The Leap from Absence to Cover-Up

The most important mechanism is the transition from uncertainty to certainty.

A missing file creates an information gap. Human beings naturally try to fill such gaps with explanations. In UFO crash cases, the cover-up hypothesis has a special advantage because it can explain almost any missing evidence.

The logic often develops in stages:
...
1. Records expected to exist cannot be found.
2. The absence seems unusual or suspicious.
3. A cover-up is proposed as a possible explanation.
4. The proposed cover-up becomes the assumed explanation.
5. Future missing records are interpreted as confirmation of the cover-up.
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_story_growth_5f6019_missing_records_susp_87219d-Illustration-3-dark.svg" | relative_url }}" alt="Missing Files illustration 3" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_story_growth_5f6019_missing_records_susp_87219d-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_story_growth_5f6019_missing_records_susp_87219d-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Missing Files Keep Crash Stories Alive

Many UFO crash stories survive not because decisive evidence emerges but because decisive resolution remains impossible.

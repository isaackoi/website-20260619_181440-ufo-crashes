...
show_ads: true
description: Police reports can establish response and chronology, but they rarely provide the calibrated data needed to identify an object.
hero_summary: Police reports can establish response and chronology, but they rarely provide the calibrated data needed to identify an object.
layout: default
...
title: Where Police Reports Stop Proving Things
title_full: Where Police Reports Stop Proving Things
display_title_short: Evidence Limits
display_title: Evidence Limits
heading_title: Where Police Reports Stop Proving Things
page_heading_title: Where Police Reports Stop Proving Things
source_count: 42
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: First Calls
  heading_title: Why The First UFO Crash Call Matters
date: '2026-06-19 15:39:17 '
header:
  og_image: /assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-1-social.jpg
  preview_image: /assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-1.webp
image: /assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-1-social.jpg
---
...
Police [records]({{ 'records/' | relative_url }}) are often among the most valuable documents in an alleged UFO crash because they are created close to the event. They can establish chronology with far greater reliability than recollections recorded decades later.
...
This distinction is often lost in UFO crash discussions. An official document may be cited as [evidence]({{ 'evidence/' | relative_url }}) that authorities "confirmed a crash", when the document actually confirms only that authorities investigated a reported crash.
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-2-dark.svg" | relative_url }}" alt="Evidence Limits illustration 2" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Physical material
...
Modern scientific standards place heavy emphasis on [calibrated sensors]({{ 'sensors/' | relative_url }}). Useful data may include:
...
This chain of custody helps prevent contamination, substitution, or later disputes about [provenance]({{ 'provenance/' | relative_url }}).


<img src="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-3-dark.svg" | relative_url }}" alt="Evidence Limits illustration 3" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_police_reports_7983df_police_reports_scien_e4cf89-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

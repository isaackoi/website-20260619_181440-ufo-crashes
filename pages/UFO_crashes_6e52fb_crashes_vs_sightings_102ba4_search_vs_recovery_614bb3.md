...
show_ads: true
description: Police, coastguard or military searches can confirm a serious report, but they do not prove that exotic wreckage was found.
hero_summary: Police, coastguard or military searches can confirm a serious report, but they do not prove that exotic wreckage was found.
layout: default
permalink: /searches/
sidebar_expanded_urls:
- /ufo-crashes/
- /crashes-vs-sightings/
nav_short_title: Searches
title: A Search Is Not a Recovery
title_full: A Search Is Not a Recovery
display_title_short: Searches
display_title: Searches
heading_title: A Search Is Not a Recovery
page_heading_title: A Search Is Not a Recovery
source_count: 52
infographic_count: 3
planned_sections:
...
* Locate debris or an [impact site]({{ 'impact-site/' | relative_url }}).
...
<img src="{{ "/assets/images/UFO_crashes_6e52fb_crashes_vs_sightings_102ba4_search_vs_recovery_614bb3-Illustration-2-dark.svg" | relative_url }}" alt="Searches illustration 2" data-theme-src-dark="{{ "/assets/images/UFO_crashes_6e52fb_crashes_vs_sightings_102ba4_search_vs_recovery_614bb3-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/UFO_crashes_6e52fb_crashes_vs_sightings_102ba4_search_vs_recovery_614bb3-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The Difference Between a Search Record and a Recovery Record

The most reliable way to separate a reported crash from a documented recovery is to examine the [paper trail]({{ 'paper-trail/' | relative_url }}).
...
The history of UFO [crash reports]({{ 'crash-reports/' | relative_url }}) repeatedly shows that official interest is often real, while evidence of recovered exotic material remains absent, disputed or undocumented. Understanding that difference helps prevent one of the most common misunderstandings in the subject: confusing a serious search for proof of a successful recovery.

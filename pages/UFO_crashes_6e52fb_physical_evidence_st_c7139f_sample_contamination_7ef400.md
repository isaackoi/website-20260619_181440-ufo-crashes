...
show_ads: true
description: Tiny traces can mislead investigators unless samples are collected, packaged, stored, and compared against known contamination sources.
hero_summary: Tiny traces can mislead investigators unless samples are collected, packaged, stored, and compared against known contamination sources.
layout: default
...
title: Could the sample have been contaminated?
title_full: Could the sample have been contaminated?
display_title_short: Contamination
display_title: Contamination
heading_title: Could the sample have been contaminated?
page_heading_title: Could the sample have been contaminated?
source_count: 56
infographic_count: 3
planned_sections:
- How handling can change a sample
- Control samples and witness materials
...
next_link:
  ...
  heading_title: Can the debris be traced?
header:
  og_image: /assets/images/UFO_crashes_6e52fb_physical_evidence_st_c7139f_sample_contamination_7ef400-Illustration-1-social.jpg
  preview_image: /assets/images/UFO_crashes_6e52fb_physical_evidence_st_c7139f_sample_contamination_7ef400-Illustration-1.webp
image: /assets/images/UFO_crashes_6e52fb_physical_evidence_st_c7139f_sample_contamination_7ef400-Illustration-1-social.jpg
---
...
Claims of unusual alloys, unexpected isotopic ratios, organic residues, or microscopic structures become difficult to evaluate if investigators cannot distinguish between the alleged object itself and contamination introduced during collection, storage, transport, or testing. The more extraordinary the claim, the more important contamination controls become.
...
This does not mean every unusual result is contamination. It means contamination must be ruled out before an unusual result can be considered meaningful.
...
None of these conditions automatically invalidate a sample. They do, however, increase uncertainty about whether laboratory findings reflect the original material or later contamination.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/oFvIuSpACQA" title="Revealing the OSIRIS-REx Asteroid Sample (Official NASA Broadcast in 4K)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=oFvIuSpACQA" target="_blank" rel="noopener noreferrer">Revealing the OSIRIS-REx Asteroid Sample (Official NASA Broadcast in 4K)</a></p><p class="youtube-embed-meta">Channel: NASA</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=oFvIuSpACQA" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=oFvIuSpACQA">Open on YouTube</a></p></div></div></div>

## Why control samples matter as much as the alleged debris

One of the most effective contamination safeguards is the collection of control samples. A control sample provides a baseline against which the alleged evidence can be compared.

At a purported crash site, useful controls may include:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Soil from areas adjacent to the recovery location.
* Local rocks and vegetation.
* Industrial materials known to exist nearby.
* Airborne dust samples.
* Materials from recovery equipment and packaging.
...
Such records make it easier to determine whether a surprising laboratory result originated from the sample itself or from the environment through which it travelled.
...
Scientists working with extraterrestrial samples often ask:


<div class="content-enhancement content-enhancement--comparison" markdown="1">

* What contaminants were present during collection?
* What contaminants were present during transport?
* What contaminants were present during storage?
* Can contamination levels be measured independently?
* Are comparison materials available?
...
## Why contamination control affects credibility

Many alleged UFO materials have generated excitement because of unusual compositions, layered structures, or unexpected analytical results. Yet the credibility of such findings depends heavily on whether contamination explanations have been systematically addressed.

A laboratory report showing an unusual elemental composition is only part of the evidential picture. Investigators also need to know:
